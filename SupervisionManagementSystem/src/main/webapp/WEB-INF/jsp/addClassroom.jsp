...
<div class="insertDataArea">
	...
	<!-- 数据表格 -->
	<table class="dataTab">
		<tr><td class="essential">教室编号：</td><td><input type="number" name="id" placeholder="0250015" min="0"></td><td class="errors"></td></tr>
		<tr><td class="essential">教室名称：</td><td><input type="text" name="name" placeholder="慎思1栋1-111"></td><td class="errors"></td></tr>
		<tr><td class="essential">座位数：</td><td><input type="number" name="seatingCapacity" placeholder="20" min="0"></td><td class="errors"></td></tr>
		...
		<tr><td>楼号：</td><td><input type="text" name="buildingNum" placeholder="慎思1栋"></td><td class="errors"></td></tr>
