		...
		<c:otherwise>
			...
			<table class="dataTab">
				<tr>
					...
					<td>学期</td><td>星期</td><td>节次</td><td>单双周</td><td>起止周</td><td>上课人数</td><td colspan="3">添加记录</td>
				...
				<c:forEach items="${courseSelectionList}" var="courseSelection">
					...
					<c:if test="${staff.power.name=='管理员'}"><td><img class="updateImage" src="images/update.gif">
