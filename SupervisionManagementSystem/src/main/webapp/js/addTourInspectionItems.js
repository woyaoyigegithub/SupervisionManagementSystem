/**
 * 1. 所有发送表单请求均规定为insertXXX,queryXXX,updateXXX,deleteXXX.（例：insertTourInspectionItems）
...
//获取表单数据，发起（url：addTourInspectionItems）http请求到后台。
function submitData(){
	var content;
